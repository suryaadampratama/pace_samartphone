...
public class Opsi2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opsi2);
        ...
        pindah.setOnClickListener(view -> {
            Intent intent = new Intent(Opsi2Activity.this, CompareActivity.class);
